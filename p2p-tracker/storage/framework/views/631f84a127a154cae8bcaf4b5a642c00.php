            ...
            <nav x-data="{ open: false }" class="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-black/10 backdrop-blur-md">
                <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
                    <div class="flex items-center gap-8">
                        <a href="<?php echo e(route('dashboard')); ?>" class="tp-headline flex items-center gap-2 text-xl font-bold uppercase tracking-[0.18em] text-[#00f0ff]">
                            <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">pause</span>
                            Trade Pulse
                        </a>

                        <div class="hidden gap-6 md:flex">
                            <a href="<?php echo e(route('dashboard')); ?>" class="tp-label py-1 text-sm transition-colors duration-300 hover:text-[#00f0ff] <?php echo e(request()->routeIs('dashboard') ? 'border-b-2 border-[#00f0ff] text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Dashboard</a>
                            <a href="<?php echo e(route('trades.index')); ?>" class="tp-label py-1 text-sm transition-colors duration-300 hover:text-[#00f0ff] <?php echo e(request()->routeIs('trades.*') ? 'border-b-2 border-[#00f0ff] text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Trades</a>
                            <a href="<?php echo e(route('capital-amount.index')); ?>" class="tp-label py-1 text-sm transition-colors duration-300 hover:text-[#00f0ff] <?php echo e(request()->routeIs('capital-amount.*') ? 'border-b-2 border-[#00f0ff] text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Capital</a>
                            <a href="<?php echo e(route('profit.withdraw.form')); ?>" class="tp-label py-1 text-sm transition-colors duration-300 hover:text-[#00f0ff] <?php echo e(request()->routeIs('profit.withdraw.form') ? 'border-b-2 border-[#00f0ff] text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Profit</a>
                        </div>
                    </div>
                    ...
                    <div class="hidden items-center gap-4 md:flex">
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2 p-2 text-[#b9cacb] transition-colors hover:text-[#00f0ff]">
                        ...
                        <div class="relative" x-data="{ menu: false }">
                            <button x-on:click="menu = !menu" class="flex items-center gap-2 p-2 text-[#b9cacb] transition-colors hover:text-[#00f0ff]">
                                ...
                                <span class="tp-label hidden text-sm sm:inline"><?php echo e(Auth::user()->name); ?></span>
                            </button>
                            ...
                            <div x-show="menu" x-on:click.outside="menu = false" x-transition class="tp-panel absolute right-0 mt-3 w-56 rounded-xl p-3">
                                <div class="border-b border-white/10 px-3 pb-3">
                                    <p class="tp-headline text-sm font-semibold text-white"><?php echo e(Auth::user()->name); ?></p>
                                    <p class="text-sm text-[#849495]"><?php echo e(Auth::user()->email); ?></p>
                                </div>
                                <div class="mt-3 space-y-1">
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="block rounded-lg px-3 py-2 text-sm text-[#b9cacb] transition hover:bg-white/5 hover:text-[#00f0ff]">Profile</a>
                ...
                <div x-show="open" x-transition class="border-t border-white/10 px-6 py-4 md:hidden">
                    <div class="flex flex-col gap-3">
                        <a href="<?php echo e(route('dashboard')); ?>" class="tp-label text-sm <?php echo e(request()->routeIs('dashboard') ? 'text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Dashboard</a>
                        <a href="<?php echo e(route('trades.index')); ?>" class="tp-label text-sm <?php echo e(request()->routeIs('trades.*') ? 'text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Trades</a>
                        <a href="<?php echo e(route('capital-amount.index')); ?>" class="tp-label text-sm <?php echo e(request()->routeIs('capital-amount.*') ? 'text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Capital</a>
                        <a href="<?php echo e(route('profit.withdraw.form')); ?>" class="tp-label text-sm <?php echo e(request()->routeIs('profit.withdraw.form') ? 'text-[#00f0ff]' : 'text-[#b9cacb]'); ?>">Profit</a>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="tp-label text-sm text-[#b9cacb]">Profile</a>
                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                            <?php echo csrf_field(); ?>
            ...
            <footer class="fixed bottom-0 left-0 z-50 flex w-full flex-col items-center justify-between gap-4 border-t border-white/5 bg-[#12131c]/80 px-6 py-4 backdrop-blur-sm md:flex-row lg:px-8">
                <div class="flex flex-col items-center gap-4 md:flex-row md:gap-6">
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        ...
                        <a href="<?php echo e(route('support.contact')); ?>" class="tp-label text-xs text-[#849495] transition hover:text-[#00f0ff]">Contact Support</a>
                    </div>
                </div>
...
<?php /**PATH C:\Users\sanas\Desktop\my learn\Projects\TradePulse\p2p-tracker\resources\views/layouts/app.blade.php ENDPATH**/ ?>